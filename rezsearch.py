...
def delete_records_and_files():
    try:
        ...
        cursor.execute("DELETE FROM resume_text WHERE unique_id LIKE '1000%'")
        cursor.execute("DELETE FROM resume_detail WHERE unique_id LIKE '1000%'")
        cursor.execute("DELETE FROM resume_keyword WHERE unique_id LIKE '1000%'")
...
def main_content():
    ...
    if selected == "RezRanker":
        ...
        query = "SELECT * FROM resume_keyword WHERE unique_id LIKE '1000%'"
    ...
    if selected == "LinkedInGPT":
        ...
        cursor.execute("SELECT linkedin_id FROM resume_detail WHERE linkedin_id != 'Nan' AND unique_id LIKE '1000%'")
